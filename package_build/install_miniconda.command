...
for version in $python_versions; do
    ...
    ./miniconda_lac/bin/conda create -n $short_version python=$version -y
done

for version in $python_versions; do
    short_version="py${version//./}"
    ./miniconda_lac/envs/$short_version/bin/python -m pip install build twine pybind11 numpy==1.26.4 setuptools wheel
done